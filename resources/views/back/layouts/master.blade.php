                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ (!empty($admindata->photo)) ? url('upload/images/'.$admindata->photo) : url('upload/no_image.jpg')}}"
                                    alt="Header Avatar">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{route('change.pass')}}"><i class="ri-wallet-2-line align-middle me-1"></i> Change Password </a>
            ...
            <div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div class="user-profile text-center mt-3">
                        <div class="">
                            <img src="{{ (!empty($admindata->photo)) ? url('upload/images/'.$admindata->photo) : url('upload/no_image.jpg')}}" alt="" class="avatar-md rounded-circle">
                        </div>
                        <div class="mt-3">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('link.index')}}">Links</a></li>
                                    <li><a href="{{route('link.create')}}">Link Create</a></li>
                                </ul>
                            </li>
